function shareStreamUsingRTCMultiConnection(stream) {
    ...
    function roomOpenCallback(isRoomOpened, roomid, error) {
        ...
        if (room_url_box === true) {
            var resultingURL = 'https://www.hiringmirror.com/screen/?s=' + connection.sessionid;
            ...
            chrome.windows.create({
                url: "data:text/html,<title>Unique Room URL</title><h2 style='text-align:center;margin-top:20px;'>Copy following private URL:</h2><input type='text' value='" + resultingURL + "' style='text-align:center;width:100%;font-size:1.2em;'><p style='text-align:center;margin-bottom:30px;'>Please copy URL and share</p>",
                type: 'popup',
                width: popup_width,
                height: popup_height,
